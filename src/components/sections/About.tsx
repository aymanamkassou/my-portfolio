    ...
    <section className="mb-16">
      ...
      <div className="card">
        ...
        <p className="mb-4">
          ...
          with the machine. There's something profound in that raw, unfiltered connection, and it's where I feel most at home.
        </p>
        <p className="mb-4">
          ...
          just as much as I do in immersing myself in a new field of study or hobby. To me, traveling is about far more than just the places—it's 
        ...
        <p>
          ...
          turned into a form of self-expression. It has become another voice, a way to channel emotions that words can't quite capture. My interests extend 
          ...
          of the cosmos. I'm drawn to anything that sparks my curiosity, whether it's a groundbreaking paper on Computer Science, the allure of a distant nebula, 
