...
export default function About() {
  return (
    <section className="mb-16">
      ...
      <div className="card">
        <p className="mb-4">
          Hello there! I'm Ayman, born in southern Morocco between the coastal charm of Agadir and the snow-capped mountains near Ouarzazate and Marrakesh. My fascination with computers began in childhood and evolved into a deep passion for Computer Science.
        </p>
        <p className="mb-4">
