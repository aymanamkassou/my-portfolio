  ...
  return (
    ...
    >
      ...
      <p className="mb-4">
        ...
        Amazigh (Tamazight), the everyday speech of Moroccans is Darija (الدارجة)—a dialect that 
        defies simple categorization.
      </p>

      <p className="mb-4">
        Though often classified as a dialect of Arabic, Moroccan Darija carries a substantial 
        substratum of Tamazight vocabulary, phonology, and grammatical structures. This influence 
        is not merely incidental but foundational to the dialect's distinctiveness.
      </p>
      ...
      <p className="mb-4">
        ...
        phonological features distinguish it from other Arabic dialects:
      </p>
